 ...
 * @param {string} line - Pipe-delimited table row
 * @param {string} section - Current section name
 * @returns {object|null} Parsed entry or null if no match
 */
 ...
 * Handles multiple section header levels (# and ##), sub-sections,
 * and optional NOTES columns in the Pending Verification section.
 *
 * @param {string} md - Raw content string
 * @returns {Array<object>} Array of parsed movie entries
 */
